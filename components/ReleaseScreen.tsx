      ...
      releaseFormOptions: {
        ...
        headerRight: () => (
          <View style={{flexDirection: 'row'}}>
            ...
            <Pressable
              onPress={() => {
                // navigation.navigate('History', { document_info: params.document_info });
              }}
              style={({pressed}) => ({
                opacity: pressed ? 0.5 : 1,
              })}>
              ...
              {/* {this.state.params.document_info &&
                this.state.params.document_info.map(item => ( */}
                  <ScrollView style={styles.infoCard}>
                    ...
                    <View>
                      <Text style={styles.detailTitle}>Upload File (Optional):</Text>
                    </View>
                    <View style={[styles.titleView,{left:20,width: (Layout.window.width / 100) * 80}]}>
                        <Button
              ...
              <View style={{flex: 1}}>
                <View
                  style={{
                    ...
                    right: 0,
                    bottom: 0,
                    top: (Layout.window.height / 100) * 4,
                  }}>
                  <Button
                    textStyle={styles.saveText}
